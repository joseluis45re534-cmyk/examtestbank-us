...
`;
        ...
        products.forEach(p => {
            // Replace legacy studizone domain with new image host
            const finalImageUrl = p.imageUrl.replace(
                /https:\/\/studiazone-com-103170\.hostingersite\.com/,
                "http://help.3dgenx.com"
            );
...
<g:image_link>${finalImageUrl}</g:image_link>
